<%@ page language="java" contentType="text/html; charset=utf-8"
    pageEncoding="utf-8"%>
<%@ page import="com.lyc.model.Admin" %>
<%@ page import="com.lyc.model.DormManager" %>
<%@ page import="com.lyc.model.Student" %>
<%
...
<div class="container">
	<form name="myForm" class="form-signin" action="login" method="post" onsubmit="return checkForm()">
		...
		<p align="center" style="padding-top: 15px;">版权所有  2019</p>
	</form>
</div>
</body>
</html>